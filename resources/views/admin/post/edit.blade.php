                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('title') is-invalid @enderror" name="title"
                      id="title" placeholder="Enter post title" value="{{ $post['title'] }}">
                    @error('title')
                  ...
                  <div class="form-group">
                    ...
                    <img src="{{ asset('image/post-image/' . $post['image']) }}" width="150"
                      class="img-thumbnail mt-2" id="thumbnail">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="btn-group btn-group-toggle" data-toggle="buttons">
                    <label class="btn bg-olive active">
                      <input type="radio" name="publish" id="option1" value="1" {{ $post['publish'] == 1 ? 'checked' : ''}}> Active
                    </label>
                    <label class="btn bg-olive">
                      <input type="radio" name="publish" value="0" id="option2" {{ $post['publish'] == 0 ? 'checked' : ''}}> Deactivated
                    </label>
                  </div>
                </div>
                <!-- /.card-body -->
