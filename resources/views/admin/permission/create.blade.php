                          ...
                          <tr>
                            ...
                            <td class="text-center">
                              <div class="icheck-primary d-inline text">
                                <input type="checkbox" id="view{{ $menu['id'] }}"
                                  name="name[{{ $menu['id'] }}][view]" value="1">
                            ...
                            <td class="text-center">
                              <div class="icheck-primary d-inline text">
                                <input type="checkbox" id="create{{ $menu['id'] }}"
                                  name="name[{{ $menu['id'] }}][create]" value="1">
                            ...
                            <td class="text-center">
                              <div class="icheck-primary d-inline text">
                                <input type="checkbox" id="edit{{ $menu['id'] }}"
                                  name="name[{{ $menu['id'] }}][edit]" value="1">
                            ...
                            <td class="text-center">
                              <div class="icheck-primary d-inline text">
                                <input type="checkbox" id="delete{{ $menu['id'] }}"
                                  name="name[{{ $menu['id'] }}][delete]" value="1">
                            ...
                            <td class="text-center">
                              <div class="icheck-primary d-inline text">
                                <input type="checkbox" id="trash{{ $menu['id'] }}"
                                  name="name[{{ $menu['id'] }}][trash]" value="1">
                            ...
                            <td class="text-center">
                              <div class="icheck-primary d-inline text">
                                <input type="checkbox" id="restore{{ $menu['id'] }}"
                                  name="name[{{ $menu['id'] }}][restore]" value="1">
                            ...
                            <td class="text-center">
                              <div class="icheck-primary d-inline text">
                                <input type="checkbox" id="remove{{ $menu['id'] }}"
                                  name="name[{{ $menu['id'] }}][remove]" value="1">
                            ...
                            <td class="text-center">
                              <div class="icheck-primary d-inline text">
                                <input type="checkbox" id="other{{ $menu['id'] }}"
                                  name="name[{{ $menu['id'] }}][other]" value="1">
